...
public class CommanderActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        btnGestionUtilisateurs.setOnClickListener(v -> {
            Intent intent = new Intent(CommanderActivity.this, GestionUtilisateursActivity.class);
            startActivity(intent);
        });

        // Redirection vers l'Édition Profil
        btnEditerProfil.setOnClickListener(v -> {
            Intent intent = new Intent(CommanderActivity.this, ModifierUserActivity.class);
            startActivity(intent);
        });
        ...
        btnPotager.setOnClickListener(v -> {
            Intent intent = new Intent(CommanderActivity.this, Potager_coursJardinageActivity.class);
            startActivity(intent);
        });
        btnStats.setOnClickListener(v -> {
            Intent intent = new Intent(CommanderActivity.this, StatistiquesActivity.class);
            startActivity(intent);
        });
    }

    private void logout() {
        Toast.makeText(CommanderActivity.this, "Déconnexion réussie", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(CommanderActivity.this, LoginActivity.class);
